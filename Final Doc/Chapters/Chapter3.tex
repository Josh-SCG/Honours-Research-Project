...
\\\\
Aside from scripts, a player prefab and crosshair were created. A prefab is a collection of objects, scripts and/or relations set in the editor that can be stored as if it were one object so that it can be "dragged and dropped" as needed. Figure \ref{cross} shows the place holder crosshair that was used until this point and the finalised crosshair. This was implemented to display where the centre of the screen is to a user.
